...
function InsertReBoard(value){
	...
	if(confirm(fid+"\n답글을 입력 하시겠습니까?")==true){
		window.location = "../ReBoardInsert.rbo?q_num="+value+"&contents="+fid;
	}else{
		return;
	}	
}
            ...
            var str ="";
               ...
               $.each(data.arr, function(key, value){                         
                   ...
                   if(value.re_state>'0'){
                      ...
                      + "<tr><td>답글</td><td ><textarea rows='3' cols='67' id='contents"+value.q_num+"'></textarea></td><td><img src='images/write.png' width='16px' onclick='InsertReBoard("+value.q_num+")'></td></tr><tr><td colspan='4'></td></tr>";                              
   ...
   <div id="game_help" class="clfix help_color_st00">   
      ...
      <div class="help_content_bx">
         <div class="content_bx_st">
            <strong class="tit">답변해야할 문의내역</strong>
