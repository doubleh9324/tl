...
<link rel="stylesheet" href="css/location.css"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
<body>
	...
	<!-- 지도시작 -->
	<div id="map" style="width:600px;height:350px;margin:15px"></div>
...
<%-- 					<img alt="" src="../img/${bean.l_img}" width="500" border="0"> --%>
<!-- 				</td> -->
...
<!-- 			</tr>			 -->
		...
		<div>
					...
					onclick="location.href='LocationListController.do'">
